...
factor_plot = (
    ...
    labs(
        ...
        subtitle="Based on World Happiness Report data (2024)",
        x="Factor",
...
- **Nordic countries tend to be happy**: Finland (`{python} round(top_countries_2024.iloc[0]['ladder_score'], 2)`), Denmark (`{python} round(top_countries_2024.iloc[1]['ladder_score'], 2)`), Iceland (`{python} round(top_countries_2024.iloc[2]['ladder_score'], 2)`), Sweden (`{python} round(top_countries_2024.iloc[3]['ladder_score'], 2)`), and Norway (`{python} round(top_countries_2024.iloc[6]['ladder_score'], 2)`) show similar balanced patterns.
