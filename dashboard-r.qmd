...
global_trends |> 
  ...
  labs(
    ...
    subtitle = "Average happiness has increased over the 12 years",
    x = "Year",
...
ggplot(aes(x = reorder(Factor, Average_Contribution), y = Average_Contribution)) +
  ...
  coord_flip() +
  labs(
    title = "Average Contribution of Factors to Worldwide Happiness",
    subtitle = 
      "Social support and per capita GDP are the greatest contributors",
    x = "Factor",
