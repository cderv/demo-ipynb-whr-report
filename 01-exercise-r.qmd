...
This report analyzes the data from the [2025 World Happiness Report](https://www.worldhappiness.report/), which looks at global happiness trends and factors that contribute to national happiness levels from 2011 to 2024. The dataset contains happiness rankings and scores for `{r} length(unique(whr$country_name))` countries over `{r} max(whr$year) - min(whr$year)` years, totaling `{r} nrow(whr)` observations.
